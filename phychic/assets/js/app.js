    ...
    if (checkDouble === true){
        ...
        if (guessesLeft > 0) {
            if (userGuess == letterToGuess) {
                ...
                document.querySelector('.mantis').innerHTML = "Good guess " + userGuess + " was the letter I was thinking of!";
                reset();
            }
            ...
            document.querySelector('.mantis').style.display = '';
            document.querySelector('.mantis').innerHTML = "Sorry, I was thinking of the letter " + letterToGuess;
